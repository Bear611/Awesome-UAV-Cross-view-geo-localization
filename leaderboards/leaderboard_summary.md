...
| Dataset | Page | Rows |
|---|---|---:|
| AerialVL | [aerialvl.md](aerialvl.md) | 7 |
| AeroVL (Flight A) | [aerovl_flight_a.md](aerovl_flight_a.md) | 1 |
| AeroVL (Flight B) | [aerovl_flight_b.md](aerovl_flight_b.md) | 1 |
| CV ACT | [cv_act.md](cv_act.md) | 6 |
| CVACT | [cvact.md](cvact.md) | 7 |
...
| University160k-WX | [university160k_wx.md](university160k_wx.md) | 1 |
| VIGOR | [vigor.md](vigor.md) | 6 |
| VIGOR (inferred from repo file eval_vigor.py and Drone2Sat/Sat2Drone protocol; dataset name not explicit in the provided table) | [vigor_inferred_from_repo_file_eval_vigor_py_and_drone2sat_sat2drone_protocol_dataset_name_not_explicit_in_the_provided_table.md](vigor_inferred_from_repo_file_eval_vigor_py_and_drone2sat_sat2drone_protocol_dataset_name_not_explicit_in_the_provided_table.md) | 2 |
| VP-Air | [vp_air.md](vp_air.md) | 3 |
| authors' constructed aerial-to-satellite image pairs dataset | [authors_constructed_aerial_to_satellite_image_pairs_dataset.md](authors_constructed_aerial_to_satellite_image_pairs_dataset.md) | 1 |
| unknown | [unknown.md](unknown.md) | 4 |
